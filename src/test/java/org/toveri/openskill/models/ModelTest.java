...
import static org.toveri.openskill.models.Model.*;
...
public class ModelTest {
    ...
    void testCalculateTeamRatingsAggregates() {
        ...
        List<TeamRating> result = calculateTeamRatings(match);
        assertAll(
    ...
    void testCalculateTeamRatings5v5v5WithRanks() {
        ...
        List<TeamRating> result = calculateTeamRatings(match, ranks);
        assertAll(
                () -> assertEquals(125, result.get(0).mu),
                () -> assertEquals(125, result.get(1).mu),
    ...
    void testC() {
        ...
        assertEquals(15.590239111558091, c(teamRatings));
        teamRatings = List.of(
                new TeamRating(0, 5 * sigmaSq, null, 0),
                new TeamRating(0, 5 * sigmaSq, null, 0)
        );
        assertEquals(27.003086243366084, c(teamRatings));
    }
    ...
    void testA() {
        ...
        assertEquals(List.of(1, 1), a(teamRatings));
        teamRatings = List.of(
                new TeamRating(0, 0, null, 1),
                new TeamRating(0, 0, null, 2),
        ...
        assertEquals(List.of(1, 1, 1, 1), a(teamRatings));
        teamRatings = List.of(
                new TeamRating(0, 0, null, 1),
                new TeamRating(0, 0, null, 1),
                new TeamRating(0, 0, null, 1),
        ...
        assertEquals(List.of(3, 3, 3, 1), a(teamRatings));
    }
    ...
    void testSumQ() {
        ...
        assertEquals(List.of(29.67892702634643, 24.70819334370875), sumQ(teamRatings, c));
        teamRatings = List.of(
                new TeamRating(5 * r.mu, 5 * sigmaSq, null, 1),
                new TeamRating(5 * r.mu, 5 * sigmaSq, null, 2)
        );
        c = c(teamRatings);
        assertEquals(List.of(204.84378810598616, 102.42189405299308), sumQ(teamRatings, c));
    }
